    ...
    <>
      <div className={rootCls}>
        <div className={innerCls}>
          ...
          {/* ── Footer ─────────────────────────────────────────────── */}
          <footer className="mt-2 border-t t-border-dim pt-2 flex items-center justify-between gap-4 flex-wrap text-xs t-muted">
            <span>
              drag <span className="t-faint">│</span> handles to resize ·{' '}
              click nodes · type{' '}
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <a
                href="https://github.com/scoegrams/situational-awareness"
                target="_blank" rel="noopener noreferrer"
                className="hover:t-text transition-colors flex items-center gap-1"
              >
              ...
              <span className="t-faint">·</span>
              <a
                href="mailto:scoegrams@gmail.com"
                className="hover:t-text transition-colors"
              >
                scoegrams@gmail.com
              </a>
